...
import avatarImage from '@/images/luis-fernandez-gonzalez.png'
          ...
          >
            ...
            <nav className="mt-6">
              <ul className="-my-2 text-base divide-y divide-zinc-100 text-zinc-800 dark:divide-zinc-100/5 dark:text-zinc-300">
                <MobileNavItem href="/servicios">Servicios</MobileNavItem>
                {/* TODO */}
                <MobileNavItem href="/#">Sobre Mi</MobileNavItem>
