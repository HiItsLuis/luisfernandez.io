...
export const meta = {
  ...
  date: '2023-03-05',
  title: 'Renderizado JS y sus consecuencias para el SEO',
  description:
    'Repaso exahustivo de los distintos tipos de renderizado de javascript y los retos que plantean para los crawlers',
}
