...
export const meta = {
  ...
  date: '2023-06-01',
  title: 'SEO Programático para pequeños negocios.',
  description:
    'Cómo enfocar una estrategia de crecimiento orgánica a partir de los datos y la generación programática de URLs.',
}
